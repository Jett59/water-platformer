...
public class State {
  ...
  public GameObject<?> createGameObject(GameObject<?> template, double x, double y) {
    if (template == null) {
      throw new NullPointerException("Can't create a game object from a null template");
    }
    try {
